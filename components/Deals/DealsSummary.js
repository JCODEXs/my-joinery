...
const DealsSummary = () => {
  return (
    <section className={classes.summary}>
      <h2> Bienvenidos a Maderafi  diseño y fabricación de muebles de madera y resinas! </h2>
   
      <div style={{background:"rgb(20,30,60,0.35)",width:"80%",position:"relative",fontSize:"1.2rem" ,borderRadius:"5px", justifyContent:"left"}}>
...
<p>
  ...
  En nuestra página web, encontrará una galería de fotos de algunos de nuestros trabajos previos, lo que le dará una idea de lo que podemos hacer por usted.
      ...
      <p style={{fontWeight:"bold", color:"black"}}> Pongase en contacto con nosotros para discutir sus ideas y solicitar un presupuesto personalizado utilizando el boton </p>
      <div>
